...
public class Circle implements Positionable, SymmetricTwoDShape {
    ...
    private final TwoDPoint center;
    ...
    public void setPosition(List<? extends Point> points) {
        ...
        double x = points.get(0).coordinates()[0];
        double y = points.get(0).coordinates()[1];
        this.center.coordinates()[0] = x;
        this.center.coordinates()[1] = y;
    }
